...
- 【YOLOv4】基于darknet的训练过程（简洁版） https://blog.csdn.net/qq_41821678/article/details/107152665
- 训练模型时候，修改了几个参数 参考地址https://github.com/Tianxiaomo/pytorch-YOLOv4/blob/master/Use_yolov4_to_train_your_own_data.md
- python train.py -l 0.001  -classes 3 -dir /Volumes/code/zhiyuan/corn-paper/coins
- 测试模型
-python models.py 3 checkpoints/Yolov4_epoch14.pth data/P00524-152409.jpg 3024 4032 data/coins.names
